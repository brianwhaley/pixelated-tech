	...
	return (
		<>
			...
			<PageSection columns={1} maxWidth="1024px" padding="20px" id="history-section">
				...
				<p>In the heart of the South Carolina Lowcountry, AMAVA Janitorial began 
				...
				<p>As their reputation flourished through word-of-mouth, AMAVA Janitorial 
				...
				<p>At AMAVA Janitorial, the philosophy remains simple: every project 
