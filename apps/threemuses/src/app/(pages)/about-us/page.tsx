		...
		<>
			...
			<PageSection columns={1} maxWidth="1024px" padding="20px" id="team-section">
				...
				<Callout
					...
					layout="horizontal"
					direction="left"
					img="https://images.ctfassets.net/luf8eony1687/2JAytZ9bA6pRjxhHbSok6u/f2f2e0a7e1d878e21304730836a8c1d9/ThreeMusesFinal-6131.jpg?fm=webp"
					title="Kathie Nolte"
