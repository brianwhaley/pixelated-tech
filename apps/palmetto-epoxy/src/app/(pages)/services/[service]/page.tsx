...
import { PageSection, ServiceDetail, contentfulValueToSlug, usePixelatedConfig } from '@pixelated-tech/components';
...
export default function ServiceDetailPage() {
	...
	return (
		<>
			<CalloutLibrary.PageTitle title={activeService?.name ? `Service - ${activeService.name}` : 'Service'}  />
			<PageSection columns={1} maxWidth="1024px" id="service-detail-wrapper">
				{activeService ? (
					<ServiceDetail serviceSlug={serviceSlug} />
				) : (
					<p>Service not found. Please return to the services list and choose another option.</p>
				)}
				<p>
                    To review our complete portfolio of offerings, <a href="/service">visit our Services Page</a>.
				</p>
			</PageSection>
