...
describe('App shell coverage', () => {
	...
	it('generates robots metadata', () => {
		expect(robots()).toMatchObject({ sitemap: '__SITE_URL__/sitemap.xml' });
	});
	...
	it('renders the not-found page', () => {
		render(<NotFound />);
		expect(screen.getByTestId('four-oh-four')).toBeInTheDocument();
	});
	...
	it('uses real config siteInfo and route data', () => {
