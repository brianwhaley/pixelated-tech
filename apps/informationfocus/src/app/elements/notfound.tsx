	...
	return (
		<section id="notfound-section">
			<div className="section-container" style={{ position: 'relative' }}>
				<SmartImage
					alt="Page Not Found"
					src="https://farm6.static.flickr.com/5762/23917768592_1c2353b913_b.jpg" 
				...
				<div className="horizontal-centered" style={{ top: '10px', width: '100%' }}>
					...
					<div className="centered-button"><a href="/index.html" target="_self" rel="noopener noreferrer">Go Home</a></div>
				</div>
			</div>
		</section>
	);
