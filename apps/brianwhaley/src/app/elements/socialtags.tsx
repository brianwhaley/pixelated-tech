...
export default function SocialTags() {
	return (
		<>
			...
			<div className="row-16col">
				<div className="grid-s1-e16">
			...
			<div className="row-12col">
				...
				<div className="grid-item"><Callout variant="full" imgShape="squircle" url="http://www.instagram.com/brian.t.whaley" img="/images/logos/instagram-logo.png" imgAlt="Instagram" title={""} content={""} /></div>

				<div className="grid-item"><Callout variant="full" imgShape="squircle" url="http://www.threads.com/brian.t.whaley" img="/images/logos/threads-logo.png" imgAlt="Threads" title={""} content={""} /></div>

				<div className="grid-item"><Callout variant="full" imgShape="squircle" url="https://nextdoor.com/p/ySPZCrQQtxCq" img="/images/logos/nextdoor-logo.png" imgAlt="Nextdoor" title={""} content={""} /></div>
				...
				<div className="grid-item"><Callout variant="full" imgShape="squircle" url="https://www.amazon.com/author/brian.t.whaley" img="/images/logos/amazon-logo.png" imgAlt="Amazon" title={""} content={""} /></div>
