...
- [ ] **Resolve ESLint Drift**: jz-home-improvement and leadscraper missing pixelated plugin enforcement. Audit and apply pixelated ESLint config to all projects. Payoff: Consistent code style, fewer lint surprises. Effort: Low
...
- [ ] **Fix Unused Dependencies**: Audit and remove unused packages across projects (md5 in 8 projects, date-fns in brianwhaley, globals in brianwhaley). Payoff: Faster npm installs, cleaner security audit reports. Effort: 2 hours
