...
// Note: lazy-load this module inside POST so tests can mock config imports before it executes.
...
export async function POST(request: Request) {
        try {
                ...
                // ===== OPTION 1: File-based storage =====
                const { savePage } = await import('../../components/sitebuilder/page/lib/pageStorageLocal');
